...
function neo.create( _numInputs, _numOutputs, _numHiddenLayers, _neuronsPerLayer, _learningRate)
  ...
  for i = 1,table.getn(self) do
    ...
    for j = 1,table.getn(self[i]) do
      ...
      if i == 1 then
        ...
        self[i][j].result = neo.transfer(self[i][j].result)
...
function neo:learn(inputs,desiredOutputs)
  ...
  self:how(inputs) --update the internal inputs and outputs
